...
**Description:** Based on the theme given on spot, use prompt to generate an image. Contestants are given a specific theme. They must generate an image that matches the style, composition, and subject of the theme as closely as possible.  
**GRADE GROUP:** B to E  
**INDIVIDUAL**

### Rules and Regulations:
1. Must start a new Chat or terminal of AI model for the competition.
2. Must not violate the host platform’s (major) safety guidelines (NSFW, extreme violence, etc.).
3. The prompt history must match the generated image. The prompts will be test-run by judges if any suspicion arises to validate the prompts.
4. The prompt history must not include any other resource (such as images or files) other than text typed by the participant. Each instruction MUST be typed by the participant completely (autocorrect and suggestions are still allowed).
5. Submission into the google form link provided on the time of competition.

### 🏆 Judging Criteria
| Criteria | Marks |
| :--- | :--- |
| Prompt Effectiveness | 35 |
| Accuracy of Output | 25 |
| Creativity & Innovation | 20 |
| Prompt Structure & Clarity | 10 |
| Efficiency (Fewest Effective Prompts) | 10 |
| **Total** | **100** |

---

# 2. Tech-Art Bonanza (Theme Based Digital Art & Digital Poster/Banner Submission)
...
### 1. ROUNDS
1. **2 rounds will be taken:**
   1. **Qualifiers:** Qualifiers will be on a MCQ question paper, where participants have to fill out OMR boxes in the OMR Answer Script.  
   ...
   2. **Finals:** Will be an on stage buzzer round.  
...
### 2. SYLLABUS
1. Syllabus will be different and difficulty will be arranged according to the groups.
2. Different groups will have different syllabus.
3. Syllabus of individual groups will be uploaded soon in facebook and instagram pages of JTC.

---

# 4. Swift-Type Blitz (Typing Competition)
...
### Video Format:
* The Video must be not more than 5mins.
* The resolution of the video must be 1080p and mp4 format.

### Student Information:
* The submitted Folder should contain the a video and in a doc file students personal information and title of the video needs to written.
...
# 8. Tech quiz (Group A to D)
### 🧠 ICT Olympiad — Technology Quiz Competition
...
# 10. Rubik’s Showdown (Rubik’s Cube Competition)

**Grade:** 3 to 12 (Group A to D)  
**Category:** 3x3 Rubik’s Cube  
**Task:** Participants must solve a standard 3×3 Rubik’s Cube within the given time. The participant with the fastest valid solving time will be ranked higher.
...
# 11. PowerPoint Presentation Competition
...
1. **Individual Participation:**
   * This is an individual-based competition.
   * Each participant must compete individually and independently.
   * Participants are responsible for the preparation and presentation of their own PowerPoint presentation.
   * Participants must be registered in the individual competition category according to the rules specified by the event organizers.
   * No other participant may assist in preparing or presenting the presentation.
2. **Theme & Topic:**
   * The theme/topic will be provided by the event organizers at a later date.
   * The same theme/topic will be applicable to all participating individuals.
   * Each participant must prepare their presentation strictly based on the given theme/topic.
   * Additional requirements and instructions will be announced along with the theme/topic.
3. **Presentation Requirements:**
   * The presentation must be created using Microsoft PowerPoint.
   * Participants should demonstrate creativity, originality, and effective use of PowerPoint features.
   * Appropriate use of images, graphics, charts, animations, transitions, and other visual elements is encouraged.
   * The presentation should be clear, well-organized, visually appealing, and easy to understand.
   * Excessive effects that distract from the content should be avoided.
4. **Number of Slides & Presentation Time:**
   * The required number of slides will be announced later by the organizers.
   * Each participant will be given a specific time limit for their presentation.
   * Participants must complete their presentation within the allocated time.
   * Exceeding the time limit may result in a deduction of marks.
5. **Submission:**
   * The presentation must be submitted according to the instructions provided by the organizers.
   * The presentation must be submitted in **.pptx format**, unless otherwise instructed.
   * Each participant should keep a backup copy of their presentation.
6. **Originality & Fair Play:**
   * The presentation must be the original work of the participating individual.
   * Plagiarism or direct copying of another person's or participant's work is strictly prohibited.
   * Any external sources used should be properly acknowledged where applicable.
   * **AI-generated presentations or fully AI-generated content will not be allowed.**
   * Any participant found violating the competition rules may be disqualified.
7. **Student’s Information:**
   * Participant’s Name
   * School Name
   * Class & Section
   * Group (A/B/C/D)
...
9. **Participant Conduct:**
   * All Participants must report to the competition venue on time.
   * Participants must follow the instructions provided by the judges and event organizers.
   * Any form of cheating, unfair practice, or inappropriate behaviour may result in disqualification.
...
# 12. Tech Bytes (Tech Article Writing Competition)

**Grade:** 3 to 12 (Group A to D)  
**Competition Type:** Individual Competition  
**Task:** Participants will write a technology-related article on the spot based on a topic or theme provided by the event organizers. The topic/theme will be announced at the competition venue, and participants will be required to complete their article within the allocated time.

### Guidelines:
1. **Topic & Theme:**
   * The topic or theme will be provided by the event organizers on the day of the competition.
   * Participants must write their article based on the given topic/theme.
   * The article should remain relevant to technology and the assigned topic.
2. **On-the-Spot Writing:**
   * All articles must be written during the allocated competition time.
   * Participants must complete their writing within the specified time limit.
   * The time limit will be announced by the event organizers before the competition begins.
3. **Writing Format:**
   * Participants must write their article in a clear and well-organized manner.
   * The article should include an appropriate title, introduction, main content, and conclusion.
   * Participants are encouraged to express their ideas clearly and creatively.
   * The use of relevant examples and practical applications is encouraged.
4. **Language:**
   * The article must be written in **English**.
   * Proper grammar, spelling, punctuation, and sentence structure should be maintained.
5. **Word Limit:**
   * The required word limit will be announced by the event organizers before the competition begins.
   * Articles exceeding or falling significantly below the specified word limit may receive a deduction in marks.
6. **Writing Materials:**
   * Participants must bring their own necessary writing materials unless otherwise instructed by the organizers.
...
9. **Participant Conduct:**
   * Participants must report to the competition venue on time.
   * Participants must follow the instructions provided by the judges and event organizers.
   * Participants must remain seated and complete their writing within the allocated time.

### IMPORTANT NOTE:
* This is an on-the-spot writing competition.
* The topic/theme will be announced at the competition venue.
* Participants must complete their article within the allocated time.
* All articles must be written in English.
* The decision of the judges and event organizers will be final.

---

# 13. Tech Meme Competition

**Grade:** 3 to 12 (Group A to D)  
**Competition Type:** Individual / Submission-Based Competition  
**Task:** Participants must create and submit a technology-related meme based on a topic, theme, or concept related to technology, computers, programming, artificial intelligence, robotics, digital life, or other relevant technology-related subjects. All submitted memes will first go through a screening and auditing process to ensure that the content is appropriate before being shortlisted for judging.

### Guidelines:
1. **Meme Content:**
   * The meme must be related to technology or a technology-related topic.
   * Participants are encouraged to create humorous, creative, and engaging content.
   * The meme should be understandable and suitable for a general audience.
   * Offensive, inappropriate, discriminatory, or harmful content will not be accepted.
2. **Submission:**
   * This is a submission-based competition.
   * Participants must submit their memes according to the instructions provided by the event organizers.
   * The submission deadline will be announced by the organizers.
   * Late submissions may not be accepted.
   * Each participant may submit one meme only, unless otherwise specified by the organizers.
3. **Meme Format:**
   * Memes must be submitted in a clear and high-quality digital format.
   * Accepted file formats may include JPG, JPEG, or PNG.
...
4. **Originality & Copyright:**
   ...
   * Participants are responsible for ensuring that their submission does not infringe upon the copyright, trademark, or intellectual property rights of others.
   * Submissions found to contain unauthorized or substantially copied content may be disqualified.
   * The organizers may request clarification or evidence regarding the originality or source of materials used in a submission.
5. **Content Screening & Auditing:**
   * All submitted memes will be screened and audited before judging.
   * The organizers will review the content to ensure that it is appropriate for display and suitable for the competition.
   * Only shortlisted and approved submissions will proceed to the final judging stage.
...
8. **Participant Responsibility:**
   * Participants are responsible for the content and materials included in their submission.
   * The organizers will not be responsible for copyright or intellectual property disputes arising from a participant's submission.
   * Participants must follow all instructions provided by the event organizers.
   * The organizers reserve the right to reject or remove any submission that violates the competition rules.

### IMPORTANT NOTE:
* This is a submission-based competition.
* All submissions will be screened and audited for content appropriateness before judging.
* Only shortlisted and approved memes will proceed to the judging stage.
* The submitted meme must be the participant's original creative work.
* Participants must not infringe upon the copyright or intellectual property rights of others.
* Any submission found to contain unauthorized or substantially copied content may be disqualified.
* The decision of the judges and event organizers will be final.

---

### Waiting on these Events from BDRO
...
* **Judging:**
  * The robots with the fastest times will be awarded. Ties will be handled by preferring the smaller/lighter robot.

---

# 15. Drone Competition (BDRO)
