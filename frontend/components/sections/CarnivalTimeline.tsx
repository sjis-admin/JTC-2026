  ...
  const days = {
    day1: {
      ...
      events: [
        ...
        { time: '04:30 PM', title: 'Robo Soccer & Speedcubing Knockout Brackets', venue: 'Robotics & Indoor Lounge', type: 'ROBOTICS' },
      ],
    },
    day2: {
      date: 'Day 2 — Friday, Oct 2, 2026',
      theme: 'Custom Drone Flight, Stage Buzzer Finals, Project Showcase & Gala Awards',
      events: [
        ...
        { time: '02:30 PM', title: 'Live Project Showcase Jury Defense & Code Zero Finals', venue: 'Main Auditorium Stage', type: 'FLAGSHIP' },
